#🧑‍💻 Sobre Mi
---
Soy un apasionado de la calidad de software en formación. Mi enfoque está en encontrar errores antes de que lleguen al usuario, asegurando una experiencia fluida y sin frustraciones. Actualmente especializándome en QA Manual y Automatización de APIs.

🛠 Skills Técnicas
Postman - JIRA - GitHub - DevTools - AndroidStudio - Python

Proyecto 1 🚗 Urban Routes Testing Project
...
* Ejecuté pruebas manuales en entornos web y móvil.
...
# 📦 Proyecto 3: Delivery Logic & API Testing
...
* Validé endpoints de API utilizando Postman.
* Verifiqué códigos de estado HTTP (200, 400).
...
* Escenarios positivos (flujo correcto)
* Escenarios negativos (errores esperados)
* Casos límite (datos extremos)
